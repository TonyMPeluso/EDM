...
The main program, "main_map.p" uses historical (2019-2021) trade data for four ASEAN countries, together with a correlation table, all available separately.
...
The other program, main_Part+Compl_Calc.py, calculates column sums for commodities that have been either partially or completely reassigned to new 2021 commodity codes. This program helps to identify "problem" commodities, whose reassignment of single AHTN 2017 to multiply AHTN 2022 commodities presents a quality issue in interpreting the final table.
